...
#      if abs(electrons[iele].eta)>2.5 or abs(electrons[iele].dxy)>0.05 or abs(electrons[iele].dz)>0.1: continue
    ...
    if n_tight_nob>3:
      j1_nob_pt=event.Jet_pt_nom[n_tight_nob[0]]
      j1_nob_eta=event.Jet_eta[n_tight_nob[0]]
      j1_nob_phi=event.Jet_phi[n_tight_nob[0]]
      j1_nob_mass=event.Jet_mass_nom[n_tight_nob[0]]
      j2_nob_pt=event.Jet_pt_nom[n_tight_nob[1]]
      j2_nob_eta=event.Jet_eta[n_tight_nob[1]]
      j2_nob_phi=event.Jet_phi[n_tight_nob[1]]
      j2_nob_mass=event.Jet_mass_nom[n_tight_nob[1]]
      j3_nob_pt=event.Jet_pt_nom[n_tight_nob[2]]
      j3_nob_eta=event.Jet_eta[n_tight_nob[2]]
      j3_nob_phi=event.Jet_phi[n_tight_nob[2]]
      j3_nob_mass=event.Jet_mass_nom[n_tight_nob[2]]
      j4_nob_pt=event.Jet_pt_nom[n_tight_nob[3]]
      j4_nob_eta=event.Jet_eta[n_tight_nob[3]]
      j4_nob_phi=event.Jet_phi[n_tight_nob[3]]
      j4_nob_mass=event.Jet_mass_nom[n_tight_nob[3]]
